...
import JLexPHP.Math.*;
import JLexPHP.Utility.*;
import JLexPHP.Utility.Error;
import JLexPHP.Utility.Set;
...
public class LexGen {
    ...
    public LexGen(String in, String out) throws IOException {
        ...
        try {
            ...
            if (index != -1) {
                outFilename = baseName.substring(0, index);
                outFilename = StringUtils.ucfirst(outFilename);
            }        
