...
class CSimplifyNfa {
    ...
    void simplify(JLexPHP.CSpec m_spec) {
     ...
     */
    private void computeClasses(JLexPHP.CSpec m_spec) {
        this.original_charset_size = m_spec.m_dtrans_ncols;
        this.ccls = new int[original_charset_size]; // initially all zero.

        int nextcls = 1;
        JLexPHP.SparseBitSet clsA = new JLexPHP.SparseBitSet(), clsB = new JLexPHP.SparseBitSet();
